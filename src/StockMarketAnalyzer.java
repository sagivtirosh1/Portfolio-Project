public class StockMarketAnalyzer {
     ...
     * Description: This file serves as a straightforward "driver" or client
     * program. It demonstrates how a developer might use the Stock component
     * directly within a main method to track a single equity over a period of
     * time.
     */
    public static void main(String[] args) {
        ...
        System.out.println("=== End of Week Report for "
                + techStock.tickerSymbol() + " ===");

        // Demonstrating Kernel Methods
        System.out.println("\n-- Basic Info --");
        System.out.println("Days Tracked: " + techStock.historySize());
        System.out.println("Initial Opening Price (Day 0): $"
                + (techStock.priceAt(0) / 100.0));
        System.out.println("Current Closing Price: $"
                + (techStock.currentPrice() / 100.0));

        // Demonstrating Secondary Methods
        System.out.println("\n-- Analytics --");
        System.out.println("Daily Change (from yesterday): $"
                + (techStock.priceChange() / 100.0));
        System.out.println(
                "Highest Price This Week: $" + (techStock.maxPrice() / 100.0));
        System.out.println(
                "3-Day Moving Avg: $" + (techStock.movingAverage(3) / 100.0));
        ...
        System.out.println(
                "Archive successfully populated: " + archive.toString());
        System.out.println(
                "Original stock post-transfer: " + techStock.toString());
